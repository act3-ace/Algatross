...
def make_env(env_id, seed, num_envs):
    def thunk():
        ...
        #     noop_max=1,  # Machado et al. 2017 (Revisitng ALE: Eval protocols) p. 12 (no-op is deprecated in favor of sticky action, right?)  # noqa: E501
...
def rollout(  # noqa: PLR0914, PLR0915
    ...
    for update in range(1, args.num_updates + 2):
        ...
        for _ in range(args.num_steps):
            ...
            cached_next_obs, action, logprob, value, key = get_actions_and_values(params, cached_next_obs, key)
            ...
            next_obs, next_reward, next_done, next_trunc, info = envs.step(cpu_action[:, None])
            env_id = info["env_id"]
            ...
            episode_lengths[env_id] *= (1 - info["terminated"]) * (1 - next_trunc)
...
if __name__ == "__main__":
    ...
    def compute_gae(
        ...
        values = jnp.concatenate([storage.values, next_value[None, :]], axis=0)  # noqa: PD011
        ...
        return advantages, advantages + storage.values  # noqa: PD011
    ...
    while True:
        ...
        sharded_next_obss = []
        sharded_next_dones = []
        for d_idx, _d_id in enumerate(args.actor_device_ids):
            for thread_id in range(args.num_actor_threads):
                (
                    global_step,
                    actor_policy_version,
